...
VALID_WORKFLOW = (
    ...
    "fieldzilla-staging-opentofu-apply.yml@refs/tags/pr-qa-v1-rc142"
)
...
class FieldZillaPlanAuthorizationTests(unittest.TestCase):
    ...
    def test_workflow_uses_remote_state_release_action(self) -> None:
        ...
        self.assertIn("uses: Synergie-ITCI/.github/actions/opentofu-plan-authorizer@pr-qa-v1-rc142", workflow)
